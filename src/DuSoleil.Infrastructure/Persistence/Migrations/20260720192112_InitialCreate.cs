    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAboutItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductAboutItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReviewTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductReviewTags_ProductReviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "ProductReviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAboutItems_ProductId",
                table: "ProductAboutItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_Name_Value",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviewTags_Name",
                table: "ProductReviewTags",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReviewTags_ReviewId",
                table: "ProductReviewTags",
                column: "ReviewId");
